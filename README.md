...
- Climate data patterns based on IMD and World Bank sources
- Agricultural statistics inspired by Ministry of Agriculture data
- Climate scenarios based on IPCC CMIP6 projections
